...
2. Confirm the production Postgres container is healthy.
3. Do not stop, restart, recreate, or reconfigure production containers from the import script.
4. Keep the production database volume intact. Do not run `docker compose down -v`.
